...
StaticModel::StaticModel(float pos_x, float pos_y, float pos_z, float scale_x, float scale_y, float scale_z, float angle, std::string path_to_model, std::string path_to_texture)
{
	position.x = pos_x;
	position.y = pos_y;
	position.z = pos_z;
	...
	loadResources(path_to_model, path_to_texture);
}

void StaticModel::loadResources(std::string path_to_model, std::string path_to_texture)
{
	model = this->LoadObj((char*)path_to_model.c_str());
	texture = this->LoadTexture((char*)path_to_texture.c_str(), GL_LINEAR, GL_LINEAR);
}

GLuint StaticModel::LoadObj(char * file) {
...
GLuint StaticModel::LoadTexture(char * file, int magFilter, int minFilter) {
